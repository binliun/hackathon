...
public class MainDialog extends ComponentDialog {
    ...
    private CompletableFuture<DialogTurnResult> choiceCardStep(WaterfallStepContext stepContext) {
        ...
        promptOptions.setPrompt(MessageFactory.text("What Azure Fundamental topics are you interested in? You can click or type the card name"));
    ...
    private List<Choice> getChoices() {
        return Arrays.asList(
            new Choice("AZ-900", "az900"),
            new Choice("Cloud Models", "cloudmodels"),
            new Choice("Benefits Of Cloud", "cloudbenefits"),
            new Choice("Cloud Service Types", "cloudservicetypes"),
